...
namespace Microsoft.Graph
{
    ...
    public class OnBehalfOfProvider : IAuthenticationProvider
    {
        ...
        public OnBehalfOfProvider(IConfidentialClientApplication confidentialClientApplication, IEnumerable<string> scopes = null)
        {
            ...
            if (Scopes.Count() == 0)
            {
                throw new AuthenticationException(
                    new Error { Code = ErrorConstants.Codes.InvalidRequest, Message = ErrorConstants.Messages.EmptyScopes },
            ...
            ClientApplication = confidentialClientApplication ?? throw new AuthenticationException(
                    new Error
                    {
                        ...
                        Message = string.Format(ErrorConstants.Messages.NullValue, "confidentialClientApplication")
                    });
        }
        ...
        /// <summary>
        /// Creates a <see cref="GraphUserAccount"/> object from a JWT access token.
        /// </summary>
        ...
        internal GraphUserAccount GetGraphUserAccountFromJwt(string jwtAccessToken)
        {
            ...
            string payloadSegment = jwtSegments.Count() == 1 ? jwtSegments.First() : jwtSegments[1];

            JwtPayload jwtPayload = JwtHelpers.DecodeToObject<JwtPayload>(payloadSegment);
